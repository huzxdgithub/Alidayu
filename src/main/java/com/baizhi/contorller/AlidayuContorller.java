...
public class AlidayuContorller {
    @RequestMapping("shortMessage")
    public void man() throws ClientException {
        //设置超时时间-可自行调整
        ...
        request.setPhoneNumbers("15503898017");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("胡章鑫");
        //必填:短信模板-可在短信控制台中找到，发送国际/港澳台消息时，请使用国际/港澳台短信模版
        request.setTemplateCode("SMS_166755118");
